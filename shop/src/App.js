...
const clothImages = [clothone, clothtwo, cloththree];
  ...
  return (
    <div className={"App start " + fade}>
      <div className="mx-auto font-pre">
        <div className="py-4 px-4 border-b border-slate-900/10 lg:px-8 lg:border-0 lg:mx-0">
            ...
            <>
              ...
              <div className="container pt-10 mx-auto">
                ...
                <button
                  ...
                  className="inline-flex justify-center my-10 rounded-lg text-sm font-semibold py-3 px-4 bg-slate-900 text-white hover:bg-slate-700"
                >
                  더보기
                </button>
              </div>
